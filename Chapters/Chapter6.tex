\chapter{Gig2Gether: Cross-Platform Datasharing to Empower, Unify \& Demystify Workers} 
...
{While quantitative data help stakeholders directly measure effects of algorithmic management on outcomes such as hours of engagement and pay \cite{calacci2022bargaining}, 
narrative accounts help generate \cite{supporting}, document and raise awareness around new, nuanced and contextual factors that contribute to invisible labor and hidden risks \cite{lived_quality}, especially given the rapidly-evolving nature of platform policies and algorithms \cite{pacifying}. 
...
In terms of issues, workers most commonly shared experiences of unsafe working conditions ---such as a driver writing about a stressful trip to drive an elderly man in distress to the ER, Figure \ref{d2_hospital}. 
